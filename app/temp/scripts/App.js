...
var _Portfolio = __webpack_require__(7);
...
//var modal = new Modal();
new _RevealOnScroll2.default((0, _jquery2.default)(".thumbnail"), "85%");
...
var StickyHeader = function () {
  function StickyHeader() {
    ...
    this.siteHeader = (0, _jquery2.default)(".site-header");
    this.headerTriggerElement = (0, _jquery2.default)(".jumbotron__text-content");
    this.createHeaderWaypoint();
    this.pageSections = (0, _jquery2.default)(".page-section");
    this.headerLinks = (0, _jquery2.default)(".site-header .primary-nav a, .site-header .site-header__logo > div > a");
